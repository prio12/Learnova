      ...
      <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center">
        <section className="w-full max-w-100">
          <div className="mb-6 text-center">
            <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-lg border border-(--border) bg-(--surface) text-sm font-semibold text-(--text-primary)">
              L
            </div>
            ...
            >
              <div>
                ...
                <input
                  ...
                  {...register('name')}
                  className={`h-10 w-full rounded-md border bg-(--surface) px-3 text-sm text-(--text-primary) outline-none transition-colors duration-150 placeholder:text-(--text-placeholder) ${
                    errors.name
              ...
              <button
                ...
                className="mt-2 h-10 w-full cursor-pointer rounded-md bg-(--accent) px-4 text-sm font-medium text-white transition-colors duration-150 hover:bg-(--accent-hover) focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60"
              >
